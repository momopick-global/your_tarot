...
function Page07ReadingResultTypeAInner() {
  ...
  return (
    <main className="w-full">
      <FlowScene
        backgroundSrc={frontCardSrc}
        backgroundFit="contain"
        allowOverflow
        hideDimOverlay
      >
        <div className="relative min-h-[560px]">
          <div className="absolute bottom-0 left-1/2 w-full max-w-[350px] -translate-x-1/2 translate-y-[calc(50%+80px)] p-3">
            ...
            <div className="pt-0.5 text-center text-[18px] text-[#e2d9ff]">{reading.titleKo}</div>
          </div>
        </div>
      </FlowScene>

      <section className="mx-auto w-full max-w-[350px] space-y-3 pb-2 pt-[146px]">
